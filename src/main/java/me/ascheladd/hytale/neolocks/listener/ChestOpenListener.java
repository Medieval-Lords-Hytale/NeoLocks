...
public class ChestOpenListener extends EntityEventSystem<EntityStore, UseBlockEvent.Pre> {
    ...
    private void handleChestOpen(
        ...
        NeoLocks.debug("Locked 1");
        
        // Send message to player
        String message = "This chest is locked by " + lockedChest.getOwnerName() + "!";
        player.sendMessage(Message.raw(message).color("#FF0000"));
    }
}